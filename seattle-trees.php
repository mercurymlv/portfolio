  ...
  <div class="case-layout">
    <article class="case-article">
      ...
      <section class="case-content">
        ...
        <p>In Seattle, we examined this relationship by plotting the percentage of people of color against tree canopy coverage at the census-tract level. The scatterplot shows an overall downward trend: as the proportion of non-white residents increases, average canopy coverage tends to decrease, consistent with national patterns.</p>
        <p>At the same time, the points are widely dispersed rather than tightly clustered, indicating substantial variation across tracts. A linear regression fitted to the data confirms that the relationship is statistically significant (p < 0.01), but the low R² value (≈ 0.06) suggests that race alone explains only a small share of the variation in canopy coverage. This spread highlights the influence of potential confounding variables—such as zoning and land-use decisions, historical development patterns, and proximity to large parks.</p>
        <figure class="case-lead-img">
